...
transsactions entre deux noeuds.  
...
Les fichiers noeuds.csv et liens.csv constitue une représentation standard
d'un graphe. Ils peuvent être utilisés conjointement pour recréer le 
graphe dans un logiciel tierce (ex: Gephi, Cytoscape, Analyst Notebook, etc)